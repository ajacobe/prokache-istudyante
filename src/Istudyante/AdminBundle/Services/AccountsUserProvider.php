...
use Istudyante\AdminBundle\Services\Exception\FailedAccountRequestException;
...
abstract class AccountsUserProvider implements UserProviderInterface
{
    protected $userService;
    protected $supportedClass;

    abstract function getUser(array $accountData);
    ...
    {
        try {
            $account = $this->//userService->find(array('email'=> $username), array('limit' => 1));
